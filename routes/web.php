...
// Inicio CRUD  Usuarios 
	...
	// ** prueba Web Service ** 
	Route::get('beneficiaries', 'BeneficiariesController@index')->name('beneficiaries.index');

	Route::post('beneficiaries/show', 'BeneficiariesController@show')->name('beneficiaries.show');
